...
/**
 * Asked once, before a booking goes to the operations desk: the papers the desk
 * will need to confirm it. The customer may say "later" - the request still
 * goes through with them marked outstanding - but they are always asked,
 * because a request that arrives with its paperwork is confirmed the same day.
 */
export function documentsRequestCard(status = null) {
  ...
  return [
    ...
    '',
    '\u0644\u0648 \u0645\u0634 \u0645\u0639\u0627\u0643 \u062f\u0644\u0648\u0642\u062a\u064a\u060c \u0627\u0643\u062a\u0628 "\u0628\u0639\u062f\u064a\u0646" \u0648\u0647\u0646\u0643\u0645\u0644 \u0627\u0644\u062d\u062c\u0632 / If you do not have them yet, reply "later" and we will book anyway.',
  ].join('\n');
}
