...
const DOCS = [
  ...
  ['docs/workflow/whatsapp-client.html', 'docs/workflow/MKY-WhatsApp-Workflow.pdf'],
  ['docs/workflow/whatsapp-technical.html', 'docs/workflow/MKY-WhatsApp-Technical.pdf'],
];
